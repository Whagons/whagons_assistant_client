...
from pydantic_ai.models import Model, ModelRequestParameters, StreamedResponse, cached_async_http_client, check_allow_model_requests
    ...
    async def _get_event_iterator(self) -> AsyncIterator[ModelResponseStreamEvent]:
        async for chunk in self._response:
            ...
            if reasoning is not None:
                yield self._parts_manager.handle_reasoning_delta(vendor_part_id='reasoning', reasoning=reasoning)
