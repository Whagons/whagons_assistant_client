...
MAX_EMAILS_TO_SEND_THIS_RUN = 150
DELAY_BETWEEN_SENDS_SECONDS = 1 # Pause between API calls (adjust if needed)
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>We are writing to alert you about a specific phishing attempt currently targeting contacts associated with Novastone Capital Advisors. An attacker is impersonating Christian Malek by sending fraudulent emails containing a fake link.</p>
