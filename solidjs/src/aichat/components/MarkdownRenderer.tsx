...
const MarkdownRenderer: Component<MarkdownRendererProps> = (props) => {
  ...
  const nonTableContent = createMemo(() => {
  ...
  return (
    <div class="markdown-renderer">
      <Show when={hasTable() && tableContent()}>
        <TableRenderer
      ...
      <Show when={nonTableContent()}>
        <SolidMarkdown
          components={{
            pre: CustomPre,
            table: () => null, // Disable table rendering in SolidMarkdown
            thead: () => null,
            tbody: () => null,
            tr: () => null,
            th: () => null,
