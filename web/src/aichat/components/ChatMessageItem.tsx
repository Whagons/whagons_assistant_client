...
import { Message, ContentItem, ImageData, PdfData } from "../models/models";
        ...
        if (typeof item === "object" && item !== null) {
          ...
          if (inner && typeof inner === "object") {
            ...
            if (inner.kind === "pdf-file") {
              ...
              return (
                <div key={index} className="my-1 p-2 bg-gray-200 dark:bg-gray-600 rounded text-sm flex items-center gap-2">
